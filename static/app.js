(() => {
  const WAKE_WORDS = ["көмекші", "көмекшім", "емші", "тапшы", "айтшы", "шашы", "айша", "меніңше", "кіші", "наша", "үшін", "шын", "барша", "қазақша", "патша", "өтірікші", "көрші", "үшін", "көмекши", "көмек", "өмір күші", "көмек ші","көмек ши"];
